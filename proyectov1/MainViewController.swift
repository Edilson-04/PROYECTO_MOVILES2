...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "CursosNavID")
        case 2:
            // Movies
            self.showViewController(viewController: UINavigationController.self, storyboardId: "AlumnosNavID")
        case 3:
            // Settings
